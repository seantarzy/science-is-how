...
function CatSet() {
  return (
    <Fade duration={2000}>
      <p>Here is a basic set of cats:</p>
      <br />
...
function DogSet() {
  return (
    <Fade duration={2000}>
      <p>Here is a basic set of dogs:</p>
      <br />
...
function BothSet() {
  return (
    <Fade duration={2000}>
      <p>Here is a basic set of cats and dogs:</p>
      <br />
...
export default function SetsBasic() {
  ...
  return (
    <div className="w-full h-full">
      ...
      <br />
      <div className="h-auto md:h-40">{miniSteps[currentMiniStep]({})}</div>
      <br />
      <div className="flex justify-between">
        <div>
          {currentMiniStep > 0 && (
            <Button
              hideIcon={true}
              onClick={() => setCurrentMiniStep((prevStep) => prevStep - 1)}
            >
              Previous
            </Button>
          )}
